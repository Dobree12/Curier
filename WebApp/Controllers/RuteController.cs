...
namespace WebApp.Controllers
{
    ...
    {
        [HttpGet]
        public IActionResult RegSediu()
        {
            return View();
        }

        [HttpPost]
        public async Task<IActionResult> RegSediu(AdaugaRutaViewModel newSediu)
        {
            ...
            // Redirect to IntrSediu after successful registration
            return RedirectToAction("IntrSediu");
        }

        [HttpGet]
        public IActionResult IntrSediu()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> IntrSediu(SediuViewModel sediu)
        {
